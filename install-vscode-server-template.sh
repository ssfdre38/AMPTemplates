...
# Microsoft VS Code Server AMP Template Installer
# This script copies the necessary files to create a Microsoft VS Code Server template in AMP
...
echo -e "${BLUE}========================================================${NC}"
echo -e "${BLUE}  Microsoft VS Code Server AMP Template Installer    ${NC}"
echo -e "${BLUE}========================================================${NC}"
echo
...
echo -e "3. Select 'Microsoft VS Code Server' from the template list"
echo -e "4. Configure your settings (authentication, workspace, etc.)"
echo -e "5. Start the instance and access via web browser"
echo
echo -e "${BLUE}Default access:${NC} http://your-server-ip:8444"
echo -e "${YELLOW}Note: This is the official Microsoft VS Code Server!${NC}"
echo